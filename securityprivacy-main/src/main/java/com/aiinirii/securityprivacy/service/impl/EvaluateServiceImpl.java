...
public class EvaluateServiceImpl {
    ...
    public String testAESvsDESUsingFile() throws Exception {
    ...
    public String testAESvsDESvsRSAMulti() throws Exception {
        ...
        StopWatch stopWatch = new StopWatch("AES vs. DES vs. RSA with text by 10 times.");
    ...
    public String testAESvsDESvsRSAUsingText() throws Exception {
        KeyPair keyRSA = generateRSAKey("defaultKey");
        SecretKeySpec keyAES = generateAESOrDESKey(128, "AES", "defaultKey");
        SecretKeySpec keyDES = generateAESOrDESKey(56, "DES", "defaultKey");
        ...
        StopWatch stopWatch = new StopWatch("AES vs. DES vs. RSA with text.");
